...
import createTeamEntity from './team.mjs'
...
const Team = createTeamEntity(sequelize, Sequelize) // Initialize the Team model
...
Team.belongsTo(User, { as: 'leader' }); // A team has a leader (User)
User.hasMany(Team);
